...
register_tag_pattern("stencil_22", MappingType.OneToOne)
register_tag_pattern("stencil_23", MappingType.OneToOne)
...
with open("fvtp2d.mlir", "r") as f:
    mlir_code = f.readlines()
codegen.from_mlir(mlir_code,"fvtp2d")
codegen.fuse_op()
