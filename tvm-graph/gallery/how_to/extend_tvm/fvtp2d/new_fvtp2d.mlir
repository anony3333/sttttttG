module {
  func @fvtp2d(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>, %arg4: !stencil.field<?x?x?xf64>, %arg5: !stencil.field<?x?x?xf64>, %arg6: !stencil.field<?x?x?xf64>, %arg7: !stencil.field<?x?x?xf64>, %arg8: !stencil.field<?x?x?xf64>, %arg9: !stencil.field<?x?x?xf64>, %arg10: !stencil.field<?x?x?xf64>, %arg11: !stencil.field<?x?x?xf64>, %arg12: !stencil.field<?x?x?xf64>, %arg13: !stencil.field<?x?x?xf64>) attributes {stencil.program} {
    %0 = stencil.cast %arg0([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %1 = stencil.cast %arg1([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %2 = stencil.cast %arg2([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %3 = stencil.cast %arg3([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %4 = stencil.cast %arg4([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %5 = stencil.cast %arg5([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %6 = stencil.cast %arg6([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %7 = stencil.cast %arg7([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %8 = stencil.cast %arg8([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %9 = stencil.cast %arg9([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %10 = stencil.cast %arg10([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %11 = stencil.cast %arg11([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %12 = stencil.cast %arg12([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %13 = stencil.cast %arg13([-8, -8, -8] : [136, 136, 136]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<144x144x144xf64>
    %14 = stencil.load %0 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %15 = stencil.load %1 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %16 = stencil.load %2 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %17 = stencil.load %3 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %18 = stencil.load %4 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %19 = stencil.load %5 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %20 = stencil.load %6 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    %21 = stencil.load %7 : (!stencil.field<144x144x144xf64>) -> !stencil.temp<?x?x?xf64>
    ...
    stencil.store %26 to %8([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    stencil.store %34 to %9([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    stencil.store %38 to %10([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    stencil.store %32 to %11([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    stencil.store %39 to %12([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    stencil.store %24 to %13([0, 0, 0] : [128, 128, 128]) : !stencil.temp<?x?x?xf64> to !stencil.field<144x144x144xf64>
    return
  }
}
