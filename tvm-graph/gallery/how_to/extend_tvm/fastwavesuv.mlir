module {
  func @fastwavesuv(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>, %arg4: !stencil.field<?x?x?xf64>, %arg5: !stencil.field<?x?x?xf64>, %arg6: !stencil.field<?x?x?xf64>, %arg7: !stencil.field<?x?x?xf64>, %arg8: !stencil.field<?x?x?xf64>, %arg9: !stencil.field<?x?x?xf64>, %arg10: !stencil.field<0x?x0xf64>) attributes {stencil.program} {
    %0 = stencil.cast %arg0([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %1 = stencil.cast %arg1([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %2 = stencil.cast %arg2([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %3 = stencil.cast %arg3([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %4 = stencil.cast %arg4([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %5 = stencil.cast %arg5([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %6 = stencil.cast %arg6([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %7 = stencil.cast %arg7([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %8 = stencil.cast %arg8([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %9 = stencil.cast %arg9([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<?x?x?xf64>) -> !stencil.field<80x80x80xf64>
    %10 = stencil.cast %arg10([-8, -8, -8] : [72, 72, 72]) : (!stencil.field<0x?x0xf64>) -> !stencil.field<0x80x0xf64>
    %11 = stencil.load %0 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %12 = stencil.load %1 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %13 = stencil.load %2 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %14 = stencil.load %3 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %15 = stencil.load %4 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %16 = stencil.load %5 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %17 = stencil.load %6 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %18 = stencil.load %7 : (!stencil.field<80x80x80xf64>) -> !stencil.temp<?x?x?xf64>
    %19 = stencil.load %10 : (!stencil.field<0x80x0xf64>) -> !stencil.temp<0x?x0xf64>
    ...
    stencil.store %24 to %8([0, 0, 0] : [64, 64, 64]) : !stencil.temp<?x?x?xf64> to !stencil.field<80x80x80xf64>
    stencil.store %25 to %9([0, 0, 0] : [64, 64, 64]) : !stencil.temp<?x?x?xf64> to !stencil.field<80x80x80xf64>
    return
  }
}